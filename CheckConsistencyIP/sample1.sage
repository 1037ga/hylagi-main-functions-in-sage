...
cons = [[y <= -7, diff(y1, t) == -10, diff(x1, t) == 0, x1 == diff(x,t),y1 == diff(y,t)], [x < 7, y == 0, diff(y1, t)== -10, diff(x1, t) == 0,x1 == diff(x,t),y1 == diff(y,t)], [x > 10, y == 0, diff(y1, t) == -10, diff(x1, t) == 0,x1 == diff(x,t),y1 == diff(y,t)]]
...
if sol == [0, [prev_x10 <= 5, prev_x10 >= 1]]:
    print('OK')
else:
    print('NG')
